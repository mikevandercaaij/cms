...
if(isset($_GET['p_id'])){
    $get_post_id = $_GET['p_id'];
        ...
        if(isset($_POST['update_post'])) {
            ...
            echo "<div class='alert alert-success' role='alert'>Post Updated: <a href='../post.php?p_id={$get_post_id}'>View Post</a> or <a href='posts.php'>See Other Posts</a></div>";
        }
...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <textarea  class="form-control" name="post_content" id="body" cols="30" rows="10"><?php echo urldecode($post_content); ?></textarea>
    </div>
